...
|------------|------|-------------------------------------|
| 1 | `motion` | `x`(i32 0-3), `y`(i32 4-7), `dx`(i32 8-11), `dy`(i32 12-15), `buttons`(u32 16-19) |
| 2 | `button_down` | `x`(i32 0-3), `y`(i32 4-7), `button`(u32 8-11), `buttons`(u32 12-15) |
| 3 | `button_up` | `x`(i32 0-3), `y`(i32 4-7), `button`(u32 8-11), `buttons`(u32 12-15) |
| 4 | `scroll` | `x`(i32 0-3), `y`(i32 4-7), `scroll_dx`(i32 8-11), `scroll_dy`(i32 12-15), `delta_unit`(u32 16-19; 0=lines, 1=pixels) |
| 5 | `enter` | `x`(i32 0-3), `y`(i32 4-7), `surface_id`(u32 8-11) |
| 6 | `leave` | `x`(i32 0-3), `y`(i32 4-7), `surface_id`(u32 8-11) |
...
|------------|------|----------------|
| 1 | `key_down` | `hid_usage`(u32 0-3), `positional`(u32 4-7, or `0xFFFFFFFF`), `modifiers`(u32 8-11) |
| 2 | `key_up` | same as `key_down` |

No auto-repeat events generated by inputfs.

#### Touch (source_role = 3)

| event_type | Name | Payload layout |
|------------|------|----------------|
| 1 | `touch_down` | `contact_id`(u32 0-3), `x`(i32 4-7), `y`(i32 8-11), `pressure`(u32 12-15; 0-1023) |
| 2 | `touch_move` | same as `touch_down` |
| 3 | `touch_up` | `contact_id`(u32 0-3), `x`(i32 4-7), `y`(i32 8-11) |

#### Pen (source_role = 4)

| event_type | Name | Payload layout |
|------------|------|----------------|
| 1 | `pen_down` | `x`(i32 0-3), `y`(i32 4-7), `pressure`(u32 8-11), `tilt_x`(i16 12-13), `tilt_y`(i16 14-15), `barrel_buttons`(u32 16-19) |
| 2 | `pen_move` | same as `pen_down` |
| 3 | `pen_up` | `x`(i32 0-3), `y`(i32 4-7), `barrel_buttons`(u32 8-11) |
