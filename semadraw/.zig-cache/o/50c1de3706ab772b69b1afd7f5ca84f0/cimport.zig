...
pub extern fn __ssp_real_arc4random_buf(__buf: ?*anyopaque, __len: usize) void;
pub inline fn arc4random_buf(arg___buf: ?*anyopaque, arg___len: usize) void {
    var __buf = arg___buf;
    _ = &__buf;
    var __len = arg___len;
    _ = &__len;
    ...
    return __ssp_real_arc4random_buf(__buf, __len);
}
pub extern fn __ssp_real_getenv_r(name: [*c]const u8, __buf: [*c]u8, __len: usize) c_int;
pub inline fn getenv_r(arg_name: [*c]const u8, arg___buf: [*c]u8, arg___len: usize) c_int {
    var name = arg_name;
    _ = &name;
    var __buf = arg___buf;
    _ = &__buf;
    ...
    return __ssp_real_getenv_r(name, __buf, __len);
}
pub extern fn __ssp_real_realpath(noalias path: [*c]const u8, noalias buf: [*c]u8) [*c]u8;
pub inline fn realpath(noalias arg_path: [*c]const u8, noalias arg_buf: [*c]u8) [*c]u8 {
    var path = arg_path;
    _ = &path;
    var buf = arg_buf;
    _ = &buf;
    if (__builtin_object_size(@as(?*const anyopaque, @ptrCast(buf)), @intFromBool(@as(c_int, 2) > @as(c_int, 1))) < @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1024))))) {
        __chk_fail();
    }
    return __ssp_real_realpath(path, buf);
}
...
pub const COLL_WEIGHTS_MAX = @as(c_int, 10);
...
pub const NL_ARGMAX = @as(c_int, 4096);
...
pub const NL_LANGMAX = @as(c_int, 31);
pub const NL_NMAX = @as(c_int, 1);
pub const MB_LEN_MAX = @as(c_int, 6);
pub const GETENTROPY_MAX = @as(c_int, 256);
pub const NSIG_MAX = @as(c_int, 128);
pub const _SYS_LIMITS_H_ = "";
pub const CHAR_BIT = __CHAR_BIT;
pub const SCHAR_MAX = __SCHAR_MAX;
pub const SCHAR_MIN = __SCHAR_MIN;
pub const UCHAR_MAX = __UCHAR_MAX;
pub const CHAR_MAX = SCHAR_MAX;
pub const CHAR_MIN = SCHAR_MIN;
pub const USHRT_MAX = __USHRT_MAX;
pub const SHRT_MAX = __SHRT_MAX;
pub const SHRT_MIN = __SHRT_MIN;
pub const UINT_MAX = __UINT_MAX;
pub const INT_MAX = __INT_MAX;
pub const INT_MIN = __INT_MIN;
pub const ULONG_MAX = __ULONG_MAX;
pub const LONG_MAX = __LONG_MAX;
pub const LONG_MIN = __LONG_MIN;
pub const ULLONG_MAX = __ULLONG_MAX;
pub const LLONG_MAX = __LLONG_MAX;
pub const LLONG_MIN = __LLONG_MIN;
pub const SSIZE_MAX = __SSIZE_MAX;
pub const SIZE_T_MAX = __SIZE_T_MAX;
pub const OFF_MAX = __OFF_MAX;
pub const OFF_MIN = __OFF_MIN;
pub const GID_MAX = UINT_MAX;
pub const UID_MAX = UINT_MAX;
pub const UQUAD_MAX = __UQUAD_MAX;
pub const QUAD_MAX = __QUAD_MAX;
pub const QUAD_MIN = __QUAD_MIN;
pub const LONG_BIT = __LONG_BIT;
pub const WORD_BIT = __WORD_BIT;
pub const MQ_PRIO_MAX = @as(c_int, 64);
pub const _SYS_SYSLIMITS_H_ = "";
pub const ARG_MAX = (@as(c_int, 2) * @as(c_int, 256)) * @as(c_int, 1024);
pub const CHILD_MAX = @as(c_int, 40);
pub const MAX_CANON = @as(c_int, 255);
pub const MAX_INPUT = @as(c_int, 255);
pub const NAME_MAX = @as(c_int, 255);
pub const NGROUPS_MAX = @as(c_int, 1023);
